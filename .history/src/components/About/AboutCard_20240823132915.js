      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>
            ...
            <br />
            I've studied key technologies including HTML, CSS, JavaScript,
            Express, Node.js, MySQL, Hive SQL, MongoDB, and Java. I'm also
            looking forward to learning Data Structures and Algorithms, React,
            Vue, and Spring Boot. Apart from coding, some other activities that
            I love to do!
          </p>
          <ul>
